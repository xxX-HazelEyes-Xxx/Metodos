 ...
 * @author Eduardo
 */
public class Eulier extends javax.swing.JFrame {
   DefaultTableModel eulierTabla;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Eulier.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
